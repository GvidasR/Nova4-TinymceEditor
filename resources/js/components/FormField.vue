...
export default {
    ...
    created() {
        if (typeof this.field.options.init === 'undefined') {
            this.field.options.init = {};
        }
    ...
    methods: {
        setupProtectContent() {
            if (typeof this.field.options.init !== 'undefined' && typeof this.field.options.init.protect !== 'undefined' && this.field.options.init.protect) {
